...
const ToWindowSpace = ({ x, y }: Vec2): Vec2 => new Vec2((x + 1) / 2 * canvasWidth, (1 - y) / 2 * canvasHeight);
const ToWorldSpace = ({ x, y }: Vec2): Vec2 => new Vec2(x / canvasWidth * 2 - 1, 1 - y / canvasHeight * 2);
/* --- */
